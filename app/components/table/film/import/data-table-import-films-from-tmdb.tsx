...
import { type action as ImportTMDBFilmsAction } from '#app/routes/admin+/dashboard+/films+/import-film-from-tmdb'
...
export function DataTableImportTMDBFilms<TData>({
	table,
	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="sm:max-w-[425px]">
				<fetcher.Form
					method="POST"
					action="/admin/dashboard/films/import-film-from-tmdb"
				>
					<DialogHeader>
