...
-- CreateTable
CREATE TABLE "FilmProductionInformation" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "filmId" TEXT NOT NULL,
    ...
    CONSTRAINT "FilmProductionInformation_productionCompanyId_fkey" FOREIGN KEY ("productionCompanyId") REFERENCES "ProductionCompany" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
...
CREATE TABLE "FilmReleaseInformation" (
    ...
    CONSTRAINT "FilmReleaseInformation_countryId_fkey" FOREIGN KEY ("countryId") REFERENCES "Country" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
