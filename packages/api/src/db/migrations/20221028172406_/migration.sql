...
-- CreateEnum
CREATE TYPE "Platform" AS ENUM ('NETFLIX', 'YOUTUBE');
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_watchlistId_fkey" FOREIGN KEY ("watchlistId") REFERENCES "Watchlist"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
